...
public class SettingOperatorPerson{
    ...
    public void setHandle(String[] split1, SendMessage sendMessage, String text, UserDTO userDTO, User user6, Status status, GroupInfoSetting groupInfoSetting) {
        ...
        if (split1[0].equals("设置操作员")||split1[0].equals("设置操作人") || split1[0].equals(constantMap.get("设置操作员"))||split1[0].equals(constantMap.get("设置操作人"))){
...
//                        userAuthority1.setUserId(userDTO.getUserId());//设置了也是null
        ...
        }else if (split1[0].equals("显示操作人")||split1[0].equals("显示操作员") ||  split1[0].equals(constantMap.get("显示操作人"))|| split1[0].equals(constantMap.get("显示操作员"))){
        ...
        ||split1[0].equals(constantMap.get("关闭显示"))||split1.equals(constantMap.get("隐藏操作人名称"))||split1.equals(constantMap.get("隐藏操作人名字"))
            ...
            accountBot.sendMessage(sendMessage,"操作成功");
        }else if (split1[0].equals("将回复人显示")||split1[0].equals("显示回复人名称")|| split1.equals(constantMap.get("将回复人显示"))
                || split1.equals(constantMap.get("显示回复人名称"))){
            status.setHandleStatus(1);
            ...
            accountBot.sendMessage(sendMessage,"操作成功");
        }else if (split1[0].equals("显示余额")||split1[0].equals("显示金额")||split1[0].equals(constantMap.get("显示余额"))||split1[0].equals(constantMap.get("显示金额"))) {
            status.setShowMoneyStatus(0);
            statusService.updateStatus("show_money_status"  ,0, userDTO.getGroupId());
            accountBot.sendMessage(sendMessage, "操作成功");
        }else if (split1[0].equals("显示USDT")||split1[0].equals("显示usdt")|| split1[0].equals(constantMap.get("显示USDT"))||split1[0].equals(constantMap.get("显示usdt"))) {
            ...
            accountBot.sendMessage(sendMessage, "操作成功");
        }else if (split1[0].equals(constantMap.get("显示1条"))||split1[0].equals(constantMap.get("显示3条"))||split1[0].equals(constantMap.get("显示5条"))){
            int i = Integer.parseInt(split1[0].substring(4,5));//Show 1 Entry
            status.setShowFew(i);
            statusService.updateStatus("show_few"            ,i , userDTO.getGroupId());
            accountBot.sendMessage(sendMessage, "操作成功");
        }
