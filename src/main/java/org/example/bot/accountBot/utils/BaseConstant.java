...
public class BaseConstant {
    ...
    public final static String[] array={
            "通知","设置日切","开启日切","关闭日切","清理今天数据",
            "删除今天数据","清理今天账单","清理今日账单","删除今日账单","清理今天帐单","删除今天账单",
            "删除账单", "删除今天帐单","删除帐单","清除账单","删除账单","清除帐单",
            "删除全部账单","清除全部账单","显示操作人名字","显示操作人名称", "设置费率",
            "设置汇率","设置入款单笔手续费","撤销入款","取消","撤销下发",
            "删除操作员", "删除操作人","设置操作员", "设置操作人", "显示操作人", "显示操作员",
            "将操作员显示","关闭显示",   "将回复人显示","显示回复人名称", "关闭回复人显示","隐藏回复人显示","显示分类",
            "设置入款单笔手续费","设置入款手续费","设置下发手续费", "设置下发单笔手续费","设置手续费","显示手续费","隐藏手续费",
            "设置单笔下发手续费","设置单笔入款手续费"
    };
    //这个是需要显示账单的
    public final static String[] showArray={
            ...
            "显示1条","显示3条","显示5条", "+0","-0","+0u","-0u","+0U","-0U",
    };
